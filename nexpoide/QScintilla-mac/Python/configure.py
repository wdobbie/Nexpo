...
# This must be kept in sync with configure-old.py, qscintilla.pro,
...
def check_qscintilla(target_config):
    ...
    if sciversstr != '2.7.3-snapshot-8b0425b87953':
        error("QScintilla %s is being used but the Python bindings 2.7.3-snapshot-8b0425b87953 are being built. Please use matching versions." % sciversstr)
