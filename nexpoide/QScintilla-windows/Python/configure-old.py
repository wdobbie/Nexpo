...
# This must be kept in sync with configure.py, qscintilla.pro,
...
def create_optparser():
    ...
    p = optparse.OptionParser(usage="python %prog [options]",
            version="2.7.3-snapshot-8b0425b87953")
...
def check_qscintilla():
    ...
    if os.access(sciglobal, os.F_OK):
        ...
        if glob.glob(os.path.join(opts.qscilibdir, "*qscintilla2*")):
            ...
            # versioning.
            if sciversstr != "2.7.3-snapshot-8b0425b87953":
                sipconfig.error("QScintilla %s is being used but the Python bindings 2.7.3-snapshot-8b0425b87953 are being built.  Please use matching versions." % sciversstr)
