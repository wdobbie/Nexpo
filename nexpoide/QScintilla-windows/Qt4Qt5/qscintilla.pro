...
# This must be kept in sync with configure.py, configure-old.py,
# example-Qt4Qt5/application.pro and designer-Qt4Qt5/designer.pro.
!win32:VERSION = 10.0.0

TEMPLATE = lib
TARGET = qscintilla2
#wjd change to staticlib, remove release
#CONFIG += qt warn_off release dll thread
CONFIG += qt warn_off staticlib thread c++11
INCLUDEPATH = . ../include ../lexlib ../src

#wjd change for static
